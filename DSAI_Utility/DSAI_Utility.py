...
def All_Initialization():
    ...
    st.image(image)
    st.markdown("<h1 style='text-align: center; color: #454545; font-size:25px;'>DMV Driver Risk Level Classification Application</h1><h2 style='text-align: center; color: blue; font-size:20px;'>Using Classification Model</h2>", unsafe_allow_html=True)
    st.markdown("""
